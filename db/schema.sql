...
CREATE TABLE IF NOT EXISTS merchants (
  ...
  -- Synced from the "AD merchant grouping" Gsheet (see db/sync-merchants.js).
  -- whatsapp_group is the escalation/WhatsApp routing group (e.g. "CarryBee
  -- Issue Group || NN1") — it is NOT the AD manager assignment, those are
  -- independent. merchant_criteria is the Gsheet's "Merchant Criteria" column
  -- (e.g. "Peak Point", "Summit Pusher", "Climb Zone").
  merchant_criteria TEXT,
  whatsapp_group    TEXT,
